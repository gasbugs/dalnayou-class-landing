...
원본: `marketing/snapshots.jsonl` · 최신 기록: 2026-07-26T14:36:37+09:00
...
| 2026-07-26~2026-07-26 | `notebooklm_enterprise_emergency` | 4,425원 | 962 | 4 | 0.4% | 4 | 100.0% | — | — | — |
| 2026-07-26~2026-07-26 | `roblox_enterprise_emergency` | 4,416원 | 1,240 | 9 | 0.7% | 10 | 111.1% | — | — | — |
...
실험: `E-009` · 6명은 개강 기준, 6명은 광고 중단 기준, 15명은 과정 정원입니다.

| 과정 | 지출 판단선 | 랜딩 판단선 | 신청 이동 | 입금 / 개강선 | 입금 / 광고중단 | 입금 / 정원 | 현재 조치 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Gemini 노트북 | 4,425 / 40,000 (11.1%) | 4 / 30 (13.3%) | — | 확인 필요 | 확인 필요 | 확인 필요 | **관찰 유지** |
| 로블록스 AI | 4,416 / 40,000 (11.0%) | 10 / 30 (33.3%) | — | 확인 필요 | 확인 필요 | 확인 필요 | **관찰 유지** |
...
- 입금 확정: **자료 부족** (신청서 제출 3회)
- 현재 판단: 노출 1,000회까지 관찰을 계속합니다.
- 기록: Exact today-only Meta ad values after the corrected creative returned to active. Link CTR 0.42%, computed landing-view cost 1,106 KRW, daily budget 20,000 KRW and status active. The 40,000 KRW spend and 30 landing-view change gates remain unmet.
...
- 입금 확정: **자료 부족** (신청서 제출 3회)
- 현재 첫 개선 후보: 광고의 첫 문장·대표 이미지·대상 문제를 우선 점검
- 기록: Exact today-only Meta ad values after the corrected creative remained active. Link CTR 0.73%, computed landing-view cost 442 KRW, daily budget 20,000 KRW and status active. Meta displayed 10 landing views and 9 link clicks in the same refreshed table; both values are retained without forcing a cross-metric correction. The 40,000 KRW spend and 30 landing-view change gates remain unmet.
