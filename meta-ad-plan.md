...
결제수단 등록과 캠페인·광고 세트 게시를 완료했고, 계정 총 지출 한도는 자동
재설정 없이 `140,000원`으로 설정했습니다. 광고 자체는 신규 광고 계정의 전화번호
SMS 인증을 요구하여 인증 화면에서 대기 중입니다. 심사 전 상태이므로 광고는 아직
게재되지 않았고 현재 광고비는 발생하지 않습니다.
