...
과정별 입금 6명은 개강 최소 인원이며 광고 중단 기준이 아닙니다. 6명 이후에도
모집을 유지하고, 정원 15명에 도달한 과정의 광고 세트만 중단합니다. 두 과정이
모두 모집 중일 때 모든 활성 광고 계정의 일 예산 합계는 `40,000원`을 넘기지
않습니다.

2026년 7월 26일 10:47 KST 최신 점검:

| 과정 | 지출 | 노출 | 링크 클릭 | 랜딩 조회 | 현재 조치 |
| --- | ---: | ---: | ---: | ---: | --- |
| Gemini 노트북 | 1,704원 | 374회 | 3회 | 3회 | 관찰 유지 |
| 로블록스 AI | 1,418원 | 259회 | 5회 | 5회 | 관찰 유지 |

두 과정 모두 링크 클릭과 랜딩 조회가 같은 수이며, 과정별 40,000원 또는 랜딩
30회의 변경 판단선에 도달하지 않았습니다. 신청서 누적 응답은 NotebookLM 2건,
로블록스 1건으로 유지되고 새 광고 UTM이 담긴 제출은 아직 없습니다. 따라서
예산·소재·타겟·목적지·신청서를 유지하고 2026년 7월 26일 20:00 KST에 다시
판단합니다.
