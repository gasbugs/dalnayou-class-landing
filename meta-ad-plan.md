...
2026년 8월 2일 운영자 요청에 따라 두 과정 광고를 각각 일 `5,000원`, 합계
일 `10,000원`으로 재개했습니다.
...
- 현재 종료 시각: `2026-08-02 23:59 KST`
- 강의장: `경기도 부천시 소사구 경인옛로 37 B107 클라우드시큐리티랩`
- 현재 혜택: `2차 얼리버드 199,000원 (2026-08-08까지)`
- 계정 지출 한도: `350,000원`
...
| --- | --- | ---: | --- | --- |
| Gemini 노트북 | `[Codex] Gemini노트북_소사역_18-44` | 5,000원 | `[Codex] Gemini노트북_업무문서문제_v2` | `notebooklm.html` |
| 로블록스 AI | `[Codex] 로블록스AI_소사역_18-44` | 5,000원 | `[Codex] 로블록스AI_기업교육신뢰_v1` | `roblox.html` |
...
이번 긴급 모집의 과정별 최소 개강 기준은 입금 완료 6명입니다. 6명에 도달해도
광고를 유지하며, 정원 15명에 도달한 과정의 광고 세트만 중단합니다. 두 과정이
모두 모집 중일 때 모든 활성 광고 계정의 일 예산 합계는 `10,000원`을 넘기지
않습니다.

사용자는 총 일 예산 `10,000원`, 종료일 `2026-08-02`, 변경된 B107 강의장과
현재 2차 얼리버드 가격을 반영하는 범위에서 광고 재개를 승인했습니다. 총 일 예산
증액이나 `2026-08-02 23:59 KST` 이후 기간 연장은 별도로 확인합니다.
...
사용자는 2026년 7월 26일 13:20 KST에 일 예산을 유지하고 계정 지출 한도만
350,000원으로 높이는 안을 승인했습니다. 13:39 KST에 변경을 실행했고
계정 누적 지출 32,897원, 남은 한도 317,103원을 확인했습니다.
...
- 설명: `2차 얼리버드 8/8까지 · 199,000원 · 잔여석 마감 임박`
- 목적지:
...
5,000원이며, Roblox 광고와 합산한 전체 일 예산은 10,000원입니다.
...
- 현재 긴급 모집 `E-009`에서 과정별 입금 6명은 개강 기준입니다. 6명에
  도달해도 모집과 광고를 유지합니다.
- 과정별 정원 15명이 입금 완료된 과정의 광고 세트만 중단하고, 해당 랜딩의
  신청 CTA를 대기 등록 안내로 전환합니다.
