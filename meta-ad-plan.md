...
2026년 7월 26일 13:43 KST 최신 점검:

| 과정 | 지출 | 노출 | 링크 클릭 | 랜딩 조회 | 현재 조치 |
| --- | ---: | ---: | ---: | ---: | --- |
| Gemini 노트북 | 3,612원 | 769회 | 3회 | 3회 | 관찰 유지 |
| 로블록스 AI | 3,360원 | 841회 | 6회 | 6회 | 관찰 유지 |
...
- 현재 긴급 모집 `E-009`는 과정별 입금 6명을 개강 기준이자 광고 중단 기준으로
  사용합니다. 6명에 도달한 과정의 광고 세트만 즉시 중단합니다.
- 과정별 정원 15명이 입금 완료되면 랜딩의 신청 CTA를 대기 등록 안내로
  전환합니다.
